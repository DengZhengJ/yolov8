...
# 指定 images 文件夹路径
image_dir = "D:/yolov8/archive/coco128/images"

# 指定 labels 文件夹路径
label_dir = "D:/yolov8/archive/coco128/labels"
...
for i in tqdm(range(len(valid_images))):
    ...
    if r < 0.1:
        # 移动到 test 文件夹
        destination = "D:/yolov8/ultralytics/datasets/test"
    elif r < 0.2:
        # 移动到 valid 文件夹
        destination = "D:/yolov8/ultralytics/datasets/valid"
    else:
        # 移动到 train 文件夹
        destination = "D:/yolov8/ultralytics/datasets/train"
